/*
Callback -> sebiuah function yang dipanggil "setelah" melakukan sebuah proses, dalam kata lain akan dipanggil setelah sebuah proses telah berjalan.
*/
...
const buyer = (message, harga) => {
  ...
  const seller = (callback) => {
    ...
    setTimeout(() => { // <~ anggaplah ini sebagai simulasi ketika sebuah proses membutuhkan waktu
