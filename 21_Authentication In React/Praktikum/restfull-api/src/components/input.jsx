...
function Input(props) {
  ...
  return (
    <div className="flex flex-col mb-4">
      ...
      <input
        className={clsx(
          "border rounded-lg bg-slate-200 dark:bg-neutral-600 border-red-500 text-black dark:text-white p-2 focus:outline-none focus:border-slate-200 focus:ring-1 focus:ring-slate-200 w-full file:border-[#0d6efd] file:hover:cursor-pointer",
