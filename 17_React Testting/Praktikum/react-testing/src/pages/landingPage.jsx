...
function LandingPage() {
  return (
    <Layout>
      ...
      <div className="py-16 bg-[#F3F5FA]">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold color">Join Our Newsletter</h2>
          ...
          <section className="py-8 md:py-16">
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="mb-4 md:mb-8">
                <h1 className="text-xl md:text-2xl font-bold mb-2 color">
                  ARSHA
                </h1>
              ...
              <div className="mb-4 md:mb-8">
                <h4 className="text-xl md:text-2xl font-bold mb-2 color">
                  Useful links
                </h4>
                <p>Home</p>
                <p>About US</p>
